...
```{r rename_meta_data_files, message=FALSE, warning=FALSE, eval=TRUE, cache=TRUE}
...
Reading the downloaded data into R can be done with `read.csv()`. By using this function we don't have to unzip the compressed file separately, since `read.csv()` can handle this for us. The following code reads the downloaded data into R. We will not run it, however, because this is slow.
