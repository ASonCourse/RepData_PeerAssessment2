...
```{r download_(meta)_data, eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE}
...
We've set `cache` to TRUE for the code chunk above to avoid endless downloading during debugging, or when running / knitting the document multiple times. Loading the data into R should also be cached, since it's a slow process with a file of this size.
