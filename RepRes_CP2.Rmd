...
**`r StormData_INJURIES[1,"EVTYPE"]`** also cause the highest number of total injuries, with `r tolower(StormData_INJURIES[2:5,"EVTYPE"])` making up the rest of the top 5. The number of injuries caused by the 'top' event is more than 13 times as big as that of the runner up.
...
```{r stacked_barplot_fatalities&injuries, fig.cap = "Barplot showing total fatalities plus injuries for each even type.", message=FALSE, warning=FALSE, cache=TRUE}
...
```{r dotplot_fatalities&injuries, fig.cap = "Dotplot showing total injuries versus total fatalities; each dot represents an even type.", message=FALSE, warning=FALSE, cache=TRUE}
...
```{r stacked_barplot_property&crop_damage, fig.cap = "Barplot showing crop damages plus property damages for each even type.", message=FALSE, warning=FALSE, cache=TRUE}
# Source of this method:
# https://stackoverflow.com/questions/30949896/creating-stacked-barplots-in-r-using-different-variables
